...
echo "<h1>Simple Multi-Tenant Database Migration</h1>";
...
try {
    ...
    echo "<h2>1. Temel Tabloları Oluşturuyorum...</h2>";
    ...
    try {
        ...
        ");
        echo "✅ tenants tablosu oluşturuldu<br>";
    } catch (Exception $e) {
        echo "❌ tenants tablosu hatası: " . $e->getMessage() . "<br>";
    }
    
    // Tenant IP ranges tablosu
    try {
        $pdo->exec("
        ...
        ");
        echo "✅ tenant_ip_ranges tablosu oluşturuldu<br>";
    } catch (Exception $e) {
        echo "❌ tenant_ip_ranges tablosu hatası: " . $e->getMessage() . "<br>";
    }
    ...
    try {
        ...
        ");
        echo "✅ roles tablosu oluşturuldu<br>";
    } catch (Exception $e) {
        echo "❌ roles tablosu hatası: " . $e->getMessage() . "<br>";
    }
    ...
    try {
        ...
        ");
        echo "✅ permissions tablosu oluşturuldu<br>";
    } catch (Exception $e) {
        echo "❌ permissions tablosu hatası: " . $e->getMessage() . "<br>";
    }
    ...
    try {
        ...
        ");
        echo "✅ role_permissions tablosu oluşturuldu<br>";
    } catch (Exception $e) {
        echo "❌ role_permissions tablosu hatası: " . $e->getMessage() . "<br>";
    }
    ...
    try {
        ...
        ");
        echo "✅ user_roles tablosu oluşturuldu<br>";
    } catch (Exception $e) {
        echo "❌ user_roles tablosu hatası: " . $e->getMessage() . "<br>";
    }
    ...
    try {
        ...
        ");
        echo "✅ audit_logs tablosu oluşturuldu<br>";
    } catch (Exception $e) {
        echo "❌ audit_logs tablosu hatası: " . $e->getMessage() . "<br>";
    }
    
    // 2. Mevcut tablolara tenant_id ekle
    echo "<br><h2>2. Mevcut Tablolara Tenant ID Ekliyorum...</h2>";
    
    $tables = ['members', 'usersInfo', 'userInvoices', 'packetsInfo', 'metroIP', 'AccessPoints'];
    ...
    foreach ($tables as $table) {
        try {
            ...
            if ($stmt->rowCount() == 0) {
                $pdo->exec("ALTER TABLE $table ADD COLUMN tenant_id INT NOT NULL DEFAULT 1");
                echo "✅ $table.tenant_id kolonu eklendi<br>";
            } else {
                echo "⚠️ $table.tenant_id kolonu zaten mevcut<br>";
            }
        } catch (Exception $e) {
            echo "❌ $table.tenant_id kolonu hatası: " . $e->getMessage() . "<br>";
        }
    }
    ...
    foreach ($tables as $table) {
        try {
            ...
            if ($stmt->rowCount() == 0) {
                $pdo->exec("ALTER TABLE $table ADD FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE");
                echo "✅ $table.tenant_id foreign key eklendi<br>";
            } else {
                echo "⚠️ $table.tenant_id foreign key zaten mevcut<br>";
            }
        } catch (Exception $e) {
            echo "❌ $table.tenant_id foreign key hatası: " . $e->getMessage() . "<br>";
        }
    }
    ...
    foreach ($tables as $table) {
        try {
            ...
            if ($stmt->rowCount() == 0) {
                $pdo->exec("CREATE INDEX $indexName ON $table(tenant_id)");
                echo "✅ $table.$indexName index eklendi<br>";
            } else {
                echo "⚠️ $table.$indexName index zaten mevcut<br>";
            }
        } catch (Exception $e) {
            echo "❌ $table.$indexName index hatası: " . $e->getMessage() . "<br>";
        }
    }
    ...
    $checkTables = ['tenants', 'tenant_ip_ranges', 'roles', 'permissions', 'role_permissions', 'user_roles', 'audit_logs'];

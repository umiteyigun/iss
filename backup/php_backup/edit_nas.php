<!-- Edit NAS Device Page -->

<div class="card fade-in-up">
    <div class="card-header">
        <h3><i class="fa fa-edit"></i> Edit NAS Device</h3>
    ...
    <div class="card-body">
        ...
        <form method="POST" action="/index.php?mod=edit_nas&nasname=<?= urlencode($nasDevice['nasname']) ?>">
            <div class="row">
                <div class="col-md-6">
                    <div style="margin-bottom: 20px;">
                        ...
                        <input type="text" 
                               ...
                               value="<?= htmlspecialchars($nasDevice['nasname'] ?? '') ?>">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div style="margin-bottom: 20px;">
                        ...
                        <input type="text" 
                               ...
                               style="width: 100%; padding: 12px; border: 1px solid #d1d5db; border-radius: 8px; font-size: 14px;"
                               placeholder="router1"
                               value="<?= htmlspecialchars($nasDevice['shortname'] ?? '') ?>">
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div style="margin-bottom: 20px;">
                        ...
                        <input type="text" 
                               ...
                               style="width: 100%; padding: 12px; border: 1px solid #d1d5db; border-radius: 8px; font-size: 14px;"
                               placeholder="admin"
                               value="<?= htmlspecialchars($nasDevice['ruser'] ?? '') ?>">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div style="margin-bottom: 20px;">
                        ...
                        <input type="password" 
                               ...
                               value="<?= htmlspecialchars($nasDevice['naspassword'] ?? '') ?>">
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div style="margin-bottom: 20px;">
                        ...
                        <input type="text" 
                               ...
                               value="<?= htmlspecialchars($nasDevice['secret'] ?? '') ?>">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div style="margin-bottom: 20px;">
                        ...
                        <input type="text" 
                               ...
                               value="<?= htmlspecialchars($nasDevice['description'] ?? '') ?>">
                    </div>
                </div>
            </div>
            ...
            <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb;">
                <div style="display: flex; gap: 12px; justify-content: flex-end;">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fa fa-save"></i> Update NAS Device
                    </button>
                </div>
            </div>
        </form>

...
<section class="content fade-in">
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">
                        <i class="fa fa-user-plus"></i> Create New Customer
                    </h3>
                    <div class="box-tools">
    ...
    <form method="POST" action="index.php?mod=doNewUser" class="form-horizontal" id="newUserForm">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input type="text" name="txtPassword" class="form-control" 
                                           placeholder="Leave empty to generate" id="password">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">
                                <i class="fa fa-user"></i> First Name <span class="text-danger">*</span>
                            </label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">
                                <i class="fa fa-user"></i> Last Name <span class="text-danger">*</span>
                            </label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">
                                <i class="fa fa-phone"></i> Phone <span class="text-danger">*</span>
                            </label>
                            <div class="col-sm-9">
                                <input type="tel" name="txtPhone1" class="form-control" required 
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div id="packetInfo" class="help-block" style="display: none;"></div>
                            </div>
                        </div>
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div id="summaryPacket" class="text-muted">None selected</div>
                            </div>
                            <div class="col-sm-6">
                                <strong>Price:</strong>
                                <div id="summaryPrice" class="text-muted">-</div>
                            </div>
                        </div>
                        <div class="row" style="margin-top: 10px;">
                            <div class="col-sm-6">
                                <strong>Router:</strong>
                                <div id="summaryRouter" class="text-muted">None selected</div>
                            </div>
                            <div class="col-sm-6">
                                <strong>Expires:</strong>
                                <div id="summaryExpire" class="text-muted">Not set</div>
                            </div>
                        </div>
                    </div>
                </div>
...
function updateSummary() {
    ...
    var price = $('#packetSelect option:selected').data('price');
    var router = $('#nasSelect option:selected').text();
    var expire = $('#datetimepicker').val();
    
    $('#summaryPacket').text(packet || 'None selected');
    $('#summaryPrice').text(price ? price + ' TL' : '-');
    $('#summaryRouter').text(router || 'None selected');
...
function validateForm() {
    ...
    // Name validation
    if (!$('input[name="txtName"]').val().trim()) {
        $('input[name="txtName"]').closest('.form-group').addClass('has-error');
        isValid = false;
    }
    
    // Lastname validation
    if (!$('input[name="txtLastname"]').val().trim()) {
        $('input[name="txtLastname"]').closest('.form-group').addClass('has-error');
        isValid = false;
    }
    
    // Phone validation
    if (!$('input[name="txtPhone1"]').val().trim()) {
        $('input[name="txtPhone1"]').closest('.form-group').addClass('has-error');
        isValid = false;
    }
...
function checkUsernameAvailability(username) {
    ...
    $.ajax({
        url: '/index.php?mod=checkUsername',
        method: 'POST',
...
#summaryPacket, #summaryPrice, #summaryRouter, #summaryExpire {
    font-size: 13px;
    margin-top: 2px;
}
